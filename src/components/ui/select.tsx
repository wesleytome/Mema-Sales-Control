  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "flex w-fit items-center justify-between gap-2 rounded-lg border border-border/60 bg-transparent px-3.5 py-2.5",
        "text-sm whitespace-nowrap shadow-xs transition-all duration-200 outline-none",
