  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "flex w-fit items-center justify-between gap-2 rounded-2xl border border-border/80 bg-input px-3.5 py-2.5",
        "text-sm whitespace-nowrap shadow-[0_1px_2px_rgba(0,0,0,0.03)] transition-all duration-200 outline-none",
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "rounded-2xl border border-border/80 shadow-[var(--box-shadow-widget)]",
          position === "popper" &&
